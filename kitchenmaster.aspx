<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kitchenmaster.aspx.cs" Inherits="kitchenmaster" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RESTAURANT | Kitchen Master</title>
                                ...
                                <div id="Div10" runat="server" align="center" style="width: 1000px; height: 500px;
                                    ...
                                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowMultiRowEdit="false" OnNeedDataSource="RadGrid1_NeedDataSource"
                                        ...
                                        <MasterTableView AutoGenerateColumns="false" DataKeyNames="ID" CommandItemDisplay="Top"
                                            CommandItemSettings-AddNewRecordText="Add New Kitchen Master" InsertItemPageIndexAction="ShowItemOnFirstPage">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="name" DataType="System.String" HeaderText="Kitchen name"
                                                ...
                                                <telerik:GridBoundColumn DataField="restname" DataType="System.String" HeaderText="Restaurant"
                                                    SortExpression="restname" UniqueName="restname">
                                                ...
                                                <FormTemplate>
                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox Width="200px" ID="txtkitchenName" MaxLength="40" EmptyMessage="Enter Kitchen Name"
                                                                    ToolTip="Maximum Length: 40" runat="server" Text='<%# Bind("Name") %>' />
                                                                <asp:Label ID="lblkname" runat="server" Visible="false" Text='<%# Bind("Name") %>' />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 15px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox Width="200px" ID="txtdescrip" TextMode="MultiLine" MaxLength="250"
                                                                    ToolTip="Maximum Length: 250" runat="server" Text='<%# Bind("Description") %>' />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 15px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="cborestname" runat="server" Height="60px" Width="200px"
                                                                    ...
                                                                    AppendDataBoundItems="True" Text='<%# Bind("Restname") %>'>
                                                                    <Items>
                                                                ...
                                                                <asp:Label ID="lblrname" runat="server" Visible="false" Text='<%# Bind("Restname") %>' />
                                                            </td>
                                                        </tr>
                                                        <tr>
