<%@ Page Language="C#" AutoEventWireup="true" CodeFile="restmaster.aspx.cs" Inherits="restmaster" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RESTAURANT | Restaurant Master</title>
                                    ...
                                    <AjaxSettings>
                                        <telerik:AjaxSetting AjaxControlID="RadGrid1">
                                            <UpdatedControls>
                                                ...
                                                <telerik:AjaxUpdatedControl ControlID="TextBoxBehavior1" />
                                            </UpdatedControls>
                                        </telerik:AjaxSetting>
                                    </AjaxSettings>
                                ...
                                <div id="Div10" runat="server" align="center" style="width: 1000px; height: 500px;
                                    ...
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
                                        ...
                                        <telerik:RadGrid runat="server" ID="RadGrid1" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="ID" CommandItemSettings-AddNewRecordText="Add New Restaurant Master">
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="name" DataType="System.Int64" HeaderText="Restaurant Name"
                                                        ReadOnly="True" SortExpression="name" UniqueName="name" AllowSorting="true" AllowFiltering="true"
                                                        Visible="true">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Address1" DataType="System.Int64" HeaderText="Address1"
                                                        ReadOnly="True" SortExpression="Address1" UniqueName="Address1" AllowSorting="true"
                                                        AllowFiltering="true" Visible="true">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Address2" DataType="System.Int64" HeaderText="Address2"
                                                        ReadOnly="True" SortExpression="Address2" UniqueName="Address2" AllowSorting="true"
                                                        AllowFiltering="true" Visible="true">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="City" DataType="System.Int64" HeaderText="City"
                                                        ReadOnly="True" SortExpression="City" UniqueName="Address2" AllowSorting="true"
                                                        AllowFiltering="true" Visible="true">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="State" DataType="System.Int64" HeaderText="State"
                                                        ReadOnly="True" SortExpression="State" UniqueName="State" AllowSorting="true"
                                                        AllowFiltering="true" Visible="true">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Country" DataType="System.Int64" HeaderText="Country"
                                                        ReadOnly="True" SortExpression="Country" UniqueName="Country" AllowSorting="true"
                                                        AllowFiltering="true" Visible="true">
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="telno" DataType="System.Int64" HeaderText="Contact"
                                                        ReadOnly="True" SortExpression="telno" UniqueName="telno" AllowSorting="true"
                                                        AllowFiltering="true" Visible="true">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                                                    ...
                                                    <telerik:GridButtonColumn Text="Delete" ConfirmText="Do u want delete" CommandName="Delete"
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="80%" border="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" style="width: 15%">
                                                                    <telerik:RadTextBox Width="200px" ID="txtname" MaxLength="50" EmptyMessage="Name"
                                                                        ToolTip="Maximum Length: 50" runat="server" Text='<%# Bind("name") %>' />
                                                                    <asp:Label ID="lblname" runat="server" Text='<%# Bind("name") %>' Visible="false" />
                                                                </td>
                                                                <td align="left">
                                                                    Address1
                                                                ...
                                                                <td align="left">
                                                                    <telerik:RadTextBox ID="txtaddress1" Text='<%# Bind("address1") %>' EmptyMessage="Address1"
                                                                        MaxLength="20" Width="200px" ToolTip="Maximum Length: 20" runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="height: 7px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <telerik:RadTextBox ID="txtaddress2" Text='<%# Bind("address2") %>' MaxLength="20"
                                                                        Width="200px" ToolTip="Maximum Length: 20" runat="server" />
                                                                </td>
                                                                <td align="left">
                                                                    city
                                                                </td>
                                                                <td align="left">
                                                                    <telerik:RadTextBox ID="txtcity" Text='<%# Bind("city") %>' MaxLength="15" Width="200px"
                                                                        ToolTip="Maximum Length: 15" runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="height: 7px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <telerik:RadTextBox ID="txtstate" Text='<%# Bind("state") %>' MaxLength="15" Width="200px"
                                                                        ToolTip="Maximum Length: 15" runat="server" />
                                                                </td>
                                                                <td align="left">
                                                                    country
                                                                ...
                                                                <td align="left">
                                                                    <telerik:RadTextBox ID="txtcountry" Text='<%# Bind("country") %>' MaxLength="15"
                                                                        Width="200px" ToolTip="Maximum Length: 15" runat="server" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="height: 7px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <telerik:RadMaskedTextBox Width="200px" ID="txttelno" SelectionOnFocus="CaretToBeginning"
                                                                        PromptChar="_" Mask="###-############" MaxLength="15" ToolTip="Maximum Length: 15"
                                                                        runat="server" Text='<%# Bind("telno") %>' />
                                                                </td>
                                                                <td align="left">
