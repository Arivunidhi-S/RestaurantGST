<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tablemaster.aspx.cs" Inherits="tablemaster" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RESTAURANT | Table Master</title>
                            ...
                            <td align="center" style="width: 80%;">
                                ...
                                <div id="Div10" runat="server" align="center" style="width: 1000px; height: 500px;
                                    ...
                                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowMultiRowEdit="false" OnNeedDataSource="RadGrid1_NeedDataSource"
                                        ...
                                        <MasterTableView AutoGenerateColumns="false" DataKeyNames="table_ID" CommandItemDisplay="Top"
                                            CommandItemSettings-AddNewRecordText="Add New Kitchen Master">
                                            <PagerStyle Mode="NextPrevNumericAndAdvanced" />
                                            <Columns>
                                                <telerik:GridEditCommandColumn ButtonType="ImageButton">
                                                    <HeaderStyle Width="5%" />
                                                </telerik:GridEditCommandColumn>
                                                <telerik:GridBoundColumn DataField="table_ID" DataType="System.Int64" HeaderText="table_ID"
                                                    ReadOnly="True" SortExpression="table_ID" UniqueName="table_ID" AllowSorting="false"
                                                    AllowFiltering="false" Visible="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="tableno" DataType="System.String" HeaderText="Table No"
                                                    SortExpression="tableno" UniqueName="tableno">
                                                ...
                                                <telerik:GridBoundColumn DataField="restid" DataType="System.String" HeaderText="Restaurant"
                                                    SortExpression="restid" UniqueName="restid">
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        <tr>
                                                            <td style="width: 20%;" align="left">
                                                                <b>
                                                                    <asp:Label ID="lblid" runat="server" Text='<%# Bind("table_id") %>' Visible="false" />
                                                                </b>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txttblno" runat="server" Width="200px" MaxLength="15" Text='<%# Bind("tableno") %>'
                                                                    ToolTip="Maximum Length: 15" EmptyMessage="Enter Table no">
                                                                </telerik:RadTextBox>
                                                                <%-- <telerik:RadNumericTextBox ID="txttblno" Text='<%# Bind("tableno") %>' EmptyMessage="Enter Table no"
                                                                    MaxLength="8" MinValue="0" MaxValue="9999" Width="200px" ToolTip="Maximum Length: 10"
                                                                    Type="Number" runat="server">
                                                                    <NumberFormat GroupSeparator="" DecimalDigits="0" />
                                                                </telerik:RadNumericTextBox>--%>
                                                                <asp:Label ID="lbltblno" runat="server" Text='<%# Bind("tableno") %>' Visible="false" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 15px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="cborestname" runat="server" Height="60px" Width="200px"
                                                                    DataSourceID="SqlDatarestname" DataTextField="name" DataValueField="id" DropDownWidth="300px"
                                                                    AppendDataBoundItems="True" Text='<%# Bind("restid") %>'>
                                                                    <Items>
                                                                        <telerik:RadComboBoxItem Text="--Select--" Value="0" ForeColor="Silver" />
                                                                    </Items>
                                                                </telerik:RadComboBox>
                                                                <asp:RequiredFieldValidator ID="RFcpy" runat="server" ControlToValidate="cborestname"
                                                                    ErrorMessage="Please select Company" SetFocusOnError="True"> 
                                                                </asp:RequiredFieldValidator>
                                                                <asp:Label ID="lblrestname" runat="server" Text='<%# Bind("restid") %>' Visible="false" />
                                                            </td>
                                                        </tr>
                                                        <tr>
