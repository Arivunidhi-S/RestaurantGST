...
<head id="Head1" runat="server">
    <title>Restaurant System | Module Master</title>
                    ...
                    <table border="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="width: 80%;">
                                ...
                                <div id="Div10" runat="server" style="width: 1000px; height: 500px; background-color: White;
                                    overflow: auto;">
                                    ...
                                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowMultiRowEdit="false" OnNeedDataSource="RadGrid1_NeedDataSource"
                                        ...
                                        AllowFilteringByColumn="true" OnUpdateCommand="RadGrid1_UpdateCommand" Skin="Forest">
                                        <MasterTableView AutoGenerateColumns="false" DataKeyNames="ModuleId" CommandItemDisplay="Top"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="ModuleName" DataType="System.String" HeaderText="ModuleName"
                                                    SortExpression="ModuleName" UniqueName="ModuleName">
                                                    <HeaderStyle Width="25%" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="FileName" DataType="System.String" HeaderText="PageName"
                                                ...
                                                <FormTemplate>
                                                    <table cellspacing="2" cellpadding="1" width="100%" border="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox Width="300px" ID="txtName" MaxLength="150" ToolTip="Maximum Length: 150"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox Width="300px" ID="txtPName" TextMode="MultiLine" MaxLength="350" ToolTip="Maximum Length: 350"
                                                                    runat="server" Text='<%# Bind("CodeFileName") %>'></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox Width="300px" ID="txtDesc" TextMode="MultiLine" MaxLength="150" Height="50px"
                                                                    ToolTip="Maximum Length: 150" runat="server" Text='<%# Bind("Description") %>'></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Label ID="Label1" Text="(Enter Y/N )" ForeColor="Red" runat="server" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
